...
<template>
  <footer class="footer-section">
    <div class="footer-section__logo-wrapper">
      <GenericIcon :name="IconName.footerLogo" size="150" />
      <span class="footer-section__copyright"
        >&#169; 2025 Pogadajmy O Agile. All Rights Reserved.</span
      >
    </div>
